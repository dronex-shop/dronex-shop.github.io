...
Kg("https://static.doubleclick.net/instream/ad_status.js",a);Rg.push($f(function(){Sg||"google_ad_status"in window||(Qg("https://static.doubleclick.net/instream/ad_status.js",a),Sg=!0,P("DCLKSTAT",3))},5E3))}}
...
b=Ve("https://googleads.g.doubleclick.net/pagead/id",a)}),function(c){c instanceof Md&&b.abort();
return Jd(c)})}
...
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();Q("PL_ATT")&&Xg.dispose();a=0;for(var b=Rg.length;a<b;a++){var c=Rg[a];if(!isNaN(c)){var d=z("yt.scheduler.instance.cancelJob");d?d(c):T(c)}}Rg.length=0;Pg("https://static.doubleclick.net/instream/ad_status.js");Sg=!1;P("DCLKSTAT",0);Kc(Fj,Ej);if(a=Dj)a.removeEventListener("onScreenChanged",Ij),a.removeEventListener("onLogClientVeCreated",Hj),a.removeEventListener("onLogServerVeCreated",Jj),a.removeEventListener("onLogVeClicked",Kj),a.removeEventListener("onLogVesShown",
Lj),a.destroy();Gj={}});
